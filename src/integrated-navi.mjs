...
@media(max-width:760px){.hp-header .nav{padding:18px 16px;gap:10px}.hp-header .brand{font-size:22px;white-space:nowrap}.hp-header .links{gap:12px;font-size:11px}.hp-header .links a{white-space:nowrap}.hp-header .links a:nth-child(-n+3){display:none}.hp-header .contact{padding:9px 11px}.hp-footer{padding:35px 24px}.hp-footer .foot-top{align-items:start}.hp-footer .brand{font-size:20px}}
`;
