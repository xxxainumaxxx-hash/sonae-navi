...
export const featuredProducts = [
 {id:'backpacks',title:'防災リュック',reasonTitle:'自分で集めると、だいたい何かが抜ける',reasonBody:'ホイッスル、簡易トイレ、給水袋、軍手、ラジオ。ひとつずつ買い足していくと、「あとで買おう」と思ったものがそのまま空欄で残ります。<strong>セットを買うのは、モノというより「抜けがない状態」を買うということ</strong>です。足りない分は、あとから足せます。',reasonNote:'まだ買わない人へ：最低限そろえるなら、水・簡易トイレ・ヘッドライトの3つからでも十分に意味があります。',lead:'初級から水・食料入り。内容やバッグの機能で選べる、1人用の3セットです。',image:'emergency-backpack-editorial-v1.png',note:'セットを土台に、常備薬・着替えなど自分に必要なものを追加してください。',items:[
 ...
 {id:'solar-power',title:'ポタ電 ＆ ソーラー',reasonTitle:'停電すると、家の中のほぼ全部が止まる',reasonBody:`停電で止まるのは、スマホの充電だけではありません。<strong>照明も、冷蔵庫も、エアコンも、電子レンジも、Wi-Fiも止まります</strong>。マンションなら給水ポンプが動かず、水も出なくなります。夏は熱中症、冬は低体温症のリスクが、家の中にいながら上がっていきます。<br>わかりやすい例がスマホです。1台をフル充電するのに必要な電力は、およそ15〜20Wh。<a class="inline-buy" href="${amz('モバイルバッテリー 20000mAh 大容量')}" target="_blank" rel="noopener sponsored noreferrer">20,000mAhのモバイルバッテリー<span aria-hidden="true">↗</span></a>は約74Whなので、<strong>フル充電3〜4回分</strong>です。4人家族が1日1回ずつ使えば、2日目には空になります。<br>ポータブル電源なら、256Whでおよそ10回以上、1,070Whで50回以上が目安です（機種と端末によって変わります）。<strong>停電が3日続いたとき、充電する手段が家にあるかどうか</strong>という話です。`,reasonNote:`まだ早いと思う人へ：まずは<a class="inline-buy" href="${amz('モバイルバッテリー 20000mAh 大容量')}" target="_blank" rel="noopener sponsored noreferrer">20,000mAhのモバイルバッテリー<span aria-hidden="true">↗</span></a>を家族の人数分。それでも1日は持ちます。無理に急ぐ買い物ではありません。`,lead:'小型・バランス・大容量。すべて純正ソーラーパネル付きのセットです。',image:'portable-power-editorial-v1.png',note:'使う機器の消費電力・起動時の電力を確認してください。ソーラー充電量は天候・日当たりで変わります。',items:[
...
<div class="reason"><p class="reason-t">${group.reasonTitle}</p><p class="reason-b">${group.reasonBody}</p><p class="reason-n">${group.reasonNote}</p></div>
