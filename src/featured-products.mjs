...
export const featuredProducts = [
 {id:'backpacks',title:'防災リュック',reasonTitle:'自分で集めると、だいたい何かが抜ける',reasonBody:'ホイッスル、簡易トイレ、給水袋、軍手、ラジオ。ひとつずつ買い足していくと、「あとで買おう」と思ったものがそのまま空欄で残ります。<strong>セットを買うのは、モノというより「抜けがない状態」を買うということ</strong>です。',reasonNote:`まだ買わない人へ：<a class="inline-buy" href="${amz('保存水 2L 長期保存 5年 箱')}" target="_blank" rel="noopener sponsored noreferrer">水<span aria-hidden="true">↗</span></a>・<a class="inline-buy" href="${amz('簡易トイレ 100回分 凝固剤')}" target="_blank" rel="noopener sponsored noreferrer">簡易トイレ<span aria-hidden="true">↗</span></a>・<a class="inline-buy" href="${amz('ヘッドライト LED 防災')}" target="_blank" rel="noopener sponsored noreferrer">ヘッドライト<span aria-hidden="true">↗</span></a>の3つからでも、十分に意味があります。`,reasonDetail:'足りない分は、あとから足せます。常備薬や着替えなど、自分にしか分からないものだけ追加すれば十分です。逆に、セットに入っているものを重複して買わずに済むので、結果として無駄が減ります。',lead:'初級から水・食料入り。内容やバッグの機能で選べる、1人用の3セットです。',image:'emergency-backpack-editorial-v1.png',note:'セットを土台に、常備薬・着替えなど自分に必要なものを追加してください。',items:[
...
<div class="section-head"><div><span class="eyebrow">THE ESSENTIALS / 01</span><h2>まず備えたい、<br>この2つ。</h2></div><p>なぜ必要かを読んでから、<br>初級・中級・上級の3商品を比較。</p></div>
